...
export const experiences: ExperienceItem[] = [
  {
    ...
    description:
      "Led the migration of critical application storage to Amazon S3, significantly enhancing durability and cost efficiency. Drove core development for a high-impact B2B2C module, designed a suite of robust RESTful APIs, implemented an auditable double-entry accounts module, and built a microservice for output generation while utilizing AI-assisted workflows to accelerate feature delivery.",
    skills: [
      "Next.js",
      "PHP",
      "AWS S3",
...
export const projects: Project[] = [
  {
    ...
    image: "",
    imageAlt:
      "A sleek developer dashboard visualizing network traffic and transaction throughput for high-concurrency systems, displaying metrics in shades of neon cyan and deep slate.",
    isFeatured: true,
    featuredLabel: "Featured_Backend",
    links: [
      {
        label: "Github",
        url: "https://github.com/dhanush-kuma/wallet-service",
      },
    ],
  },
  {
    title: "Captain's Log: Local RAG Search",
    tag: "backend / ai-engineering",
    description:
    ...
    links: [
      {
        label: "Github",
        url: "https://github.com/dhanush-kuma/talk-to-your-pirate-notes",
      },
    ],
  },
  {
    ...
    image: "",
    imageAlt:
      "Close up of a sleek brain neural connectivity interface and glowing signal paths in deep charcoal and neon blue lighting.",
    links: [],
  },
  {
    title: "Intellect",
  ...
  },
  {
    ...
    links: [
      {
        label: "Github",
        url: "https://github.com/dhanush-kuma/bookmark-oauth",
      },
    ],
  },
  {
...
export const blogs: BlogPost[] = [
  {
    ...
    date: "MARCH 14, 2024",
    description:
      "A deep dive into the challenges of maintaining data consistency and low latency in distributed transaction systems using Apache Kafka and Event Sourcing patterns.",
    readTime: "12 MIN_READ",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuC1riyEoyj0kCvJXnXCYRYUvP4znF7UzpsKfjwnhW90N9ffHBVIgc6KS3jTEvFbKz70nxOfR-O0IlMFUPfmH-qG6QyFQONzCYcI50gVs5WRr7C8HNMuK2V4iMe7VdRvhx469LeCMEpaFGz8VYwhMh2rg_pg9N1P22IhWo5fSxco5aNc2-2Ps4Z8pjyrGhv7xKb1zhI4CwIHDv35o2PrgaRHDYZe2fME_JwQE9rAiH2_JXaz4LdWu8pGi-l08FsMcPF5fbxrG-BM7Q",
  ...
  },
  {
    ...
    description:
      "Evaluating Module Federation as a solution for decoupling monolithic frontend architectures without sacrificing user experience or developer productivity.",
    readTime: "8 MIN_READ",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCKDiPvy3aIYjoCU_jTGFbK5jJei8cU5JejFAoPPStxB-AzuNTk8uSpu-NjUzHwrvSAYiIh7pijQCT-Mi0H0qVzhs7SNRIxSQ8MHtw-tHOi9zwQBC7QPJdptkqvWe2_2Btwg6zqASBho8JyQaaZcsqq3eROn8Tzoyv-P_Bm8YIG7lA-6fhDBc_afbGZ6lu_5H7tGUIPD4bmjpUgbhM5f-b1VFY-5XX2waycC8-563YGXdEiKocyZd9UA0RfwtI4sdvPN7n2nqyZTw",
  ...
  },
  {
    ...
    category: "DEVOPS",
    description:
      "How to leverage custom controllers to automate complex stateful application updates while maintaining 99.99% availability.",
    readTime: "10 MIN_READ",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCcMCjBMcknk6cih72k2D_v9TknPLNGaGuxvPZKmc9EeILHo_mWmDsF96DyryftN0uMPY0zTp3ueOiGOGrCisZhve9gtvJs0UvWKwSPxG19wMKI8xDb4rpGO22MqM-ziEwfq7TUjR9ObLTMA5q51hIcd7mw2wultuW5foc2LrIThQ_O5Yp_-lA19CacFo7l3CLhoNYacja15hFgN5GKmW3e9kguKJwr0d7Jo-SKxf5-lb1EEvHIl3PENRJMD8rxTyYq3dKS9c8u7g",
  ...
  },
  {
    ...
    description:
      "Benchmarking data processing speeds across different runtimes and understanding when the overhead of Rust pays for itself.",
    readTime: "15 MIN_READ",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAtFEM1fcLISLD-I1Cb7ToTpzp2gMVrR9DymCsCVzdQC4TR8-TTszNJQmC4nlC6shzUw3A3lseMVwg-X30EcDeqjb4Y7jExVa3Hg7oZSmepohYApb-6FGc-I8nEbfLP-E6Ve1GPVD_Wl5u2nZ9CNjPON25DwLnmt4Yrqf6Y9DYmZQebFQPfy-g0TgJd0I19zQYUSqhLbZV08Nrv4y5-U8KypBRVGJPFtnqyMkWLrlgvqTzuiIPtAncpUEmKW9rmF8vfNnOyPK0sIQ",
...
export const socials: SocialLink[] = [
  { name: "Github", icon: "terminal", url: "https://github.com/dhanush-kuma" },
  {
    name: "LinkedIn",
    icon: "groups",
    url: "https://www.linkedin.com/in/dhanush-kuma/",
  },
